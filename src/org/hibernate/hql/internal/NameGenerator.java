...
/**
 * Provides utility methods for generating HQL / SQL names. Shared by both the 'classic' and 'new'
 * query translators.
 * @author josh
 */
public final class NameGenerator {
    /**
     * Private empty constructor (checkstyle says utility classes should not have default
     * constructors).
     */
    ...
    // 根据达梦匹配大小写的问题，统一将别名改成大写
    public static String scalarName(int x, int y) {
        return new StringBuilder().append("col_").append(x).append('_').append(y).append('_').toString().toUpperCase();
    }
}
